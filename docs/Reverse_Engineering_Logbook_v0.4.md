# Project Phoenix — Reverse Engineering Logbook v0.4

## Missie
UEFA Manager 2000 systematisch ontleden zodat eerst een functioneel 1-op-1 webspel kan worden gebouwd en pas daarna een remaster.

## Primaire bronnen
- Originele UEFA Manager 2000-handleiding
- Installatie- en Data-map
- Gecontroleerde savegames
- Screenshots en praktijktests
